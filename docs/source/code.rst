...
.. automodule:: swift_browser_ui.ui
   :synopsis: The ``swift_browser_ui.ui`` package contains code for Object
              Browser UI itself.

.. autosummary::
    :toctree: swift_browser_ui.ui
...
.. automodule:: swift_browser_ui.sharing
    :synopsis: The ``swift_browser_ui.sharing`` package contains code for
               the Object Browser container sharing functionality.
...
.. automodule:: swift_browser_ui.request
    :synopsis: The ``swift_browser_ui.request`` package contains code for
               the Object Browser container access request functionality.
...
.. automodule:: swift_browser_ui.upload
    :synopsis: The ``swift_browser_ui.upload`` package contains code for
               the Object Browser extended upload and download functionality.

.. autosummary::
    :toctree: swift_browser_ui.upload
