...
class LoginTestClass(asynctest.TestCase):
    ...
    async def test_sso_query_end_successful_http_form(self):
        ...
        patch4 = unittest.mock.patch("keystoneauth1.session.Session")
    ...
    async def test_sso_query_end_unsuccessful_missing_token(self):
        ...
        patch2 = unittest.mock.patch("keystoneauth1.identity.v3.Token")
        patch3 = unittest.mock.patch("keystoneauth1.session.Session")
        patch4 = unittest.mock.patch("swiftclient.service.SwiftService")
