...
- Fix converted bucket status shown as not converted
...
- Undo non-urgent conversion status text #1353 change
...
- (users) Added an alert about shares from v2 missing in v3 (#1342)

### Fixed

- Fixed a flash of default-type alert

## [2026.4.5] - 2026-04-24

### Changed

- (users) Disable share modal opening for incompatible buckets (#1339)

## [2026.4.4] - 2026-04-23

### Changed

- (users) Disable failing bucket actions on incompatible legacy buckets (#1306)

### Fixed

- (users) Expand the check for incompatible legacy buckets (#1337)

## [2026.4.3] - 2026-04-14

### Security

- (admins) allow SD Connect to use stale ciphers for LDAP connection
- allow SD Connect to use stale ciphers for LDAP connection
...
- triggering downstream image build pipeline
...
- (users) buckets owned by you no longer displayed as shared, in specific edge cases
- don't return owned bucket as part of the shared bucket listing
...
[Unreleased]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/swift-browser-ui/compare/2026.9.4...HEAD
[2026.9.4]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/swift-browser-ui/compare/2026.9.3...2026.9.4
...
[2026.4.4]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/swift-browser-ui/compare/2026.4.3...2026.4.4
[2026.4.3]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/swift-browser-ui/compare/2026.4.2...2026.4.3
[2026.4.2]: https://gitlab.ci.csc.fi/sds-dev/sd-connect/swift-browser-ui/compare/2026.4.1...2026.4.2
