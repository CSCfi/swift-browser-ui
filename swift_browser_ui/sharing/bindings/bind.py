...
class SwiftXAccountSharing:
    ...
    @staticmethod
    def parse_list_to_string(to_parse: typing.List[str]) -> str:
    ...
    async def get_access(self, username: str) -> typing.List[dict]:
    ...
    async def get_share(self, username: str) -> typing.List[dict]:
    ...
    async def get_share_details(self, username: str, container: str) -> dict:
    ...
    async def share_delete_access(
        self, username: str, container: str, userlist: typing.List[str]
    ) -> bool:
        ...
        async with self.session.delete(url, params=params, ssl=ssl_context) as resp:
            if resp.status == 204:
                ...
                logging.error(
                    f"API call {resp.url} responded with status "
