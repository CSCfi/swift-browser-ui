...
frontend: CI=true SWIFT_UI_SECURE_WEBSOCKET=s ALLOWED_HOSTS=${SWIFT_UI_FRONTEND_ALLOW_HOSTS} SWIFT_UI_TLS_PORT=${SWIFT_UI_TLS_PORT} SWIFT_UI_TLS_HOST=${SWIFT_UI_TLS_HOST} PORT=${FRONTEND_PORT} BACKEND_PORT=${BACKEND_PORT} pnpm --prefix swift_browser_ui_frontend/ run serve
