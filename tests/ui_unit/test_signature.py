...
class SignatureMiscTestClass(asynctest.TestCase):
    ...
    def setUp(self):
        ...
        self.session_check_patch = unittest.mock.patch(
            "swift_browser_ui.signature.session_check", self.session_check_mock
        )
        ...
        self.get_tempurl_key_patch = unittest.mock.patch(
            "swift_browser_ui.signature.get_tempurl_key", self.get_tempurl_key_mock
        )
...
class SignatureTokenTestClass(asynctest.TestCase):
    ...
    def setUp(self):
        ...
        self.setd_patch = unittest.mock.patch(
            "swift_browser_ui.signature.setd", self.setd_mock
        )
        ...
        self.setd_missing_patch = unittest.mock.patch(
            "swift_browser_ui.signature.setd", self.setd_mock_missing_endpoints
        )
